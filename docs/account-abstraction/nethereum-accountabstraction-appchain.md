---
title: "Nethereum.AccountAbstraction.AppChain"
sidebar_label: "Nethereum.AccountAbstraction.AppChain"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AccountAbstraction.AppChain/README.md"
format: md
---

# Nethereum.AccountAbstraction.AppChain

> **NuGet**: [`Nethereum.AccountAbstraction.AppChain`](https://www.nuget.org/packages/Nethereum.AccountAbstraction.AppChain/) | **Source**: [`src/Nethereum.AccountAbstraction.AppChain/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AccountAbstraction.AppChain)
# Nethereum.AccountAbstraction.AppChain

> **PREVIEW** — This package is in preview. APIs may change between releases.

ERC-4337 Account Abstraction for [Nethereum AppChain](../application-chain/nethereum-appchain) — simplified user onboarding with sponsored gas, admin-controlled whitelisting, and automated infrastructure deployment.
...
- **[Nethereum.AccountAbstraction.Bundler](nethereum-accountabstraction-bundler)** - Bundler configuration

### See Also
- **[Nethereum.AppChain.Server](../application-chain/nethereum-appchain-server)** - AppChain server that hosts the bundler
