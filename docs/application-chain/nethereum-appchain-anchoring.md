---
title: "Nethereum.AppChain.Anchoring"
sidebar_label: "Nethereum.AppChain.Anchoring"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.Anchoring/README.md"
format: md
---

# Nethereum.AppChain.Anchoring

> **NuGet**: [`Nethereum.AppChain.Anchoring`](https://www.nuget.org/packages/Nethereum.AppChain.Anchoring/) | **Source**: [`src/Nethereum.AppChain.Anchoring/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.Anchoring)
# Nethereum.AppChain.Anchoring

> **PREVIEW** — This package is in preview. APIs may change between releases.

L1 state root anchoring for [Nethereum AppChain](nethereum-appchain) — anchored to Ethereum for trust.
...
### Used By (Consumers)
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - Server integrates anchor worker for automated anchoring
- **[Nethereum.AppChain.Sync](nethereum-appchain-sync)** - Sync uses anchors to determine finality

### Dependencies
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - Block header access
- **[Nethereum.Web3](../core-foundation/nethereum-web3)** - L1 contract interaction
