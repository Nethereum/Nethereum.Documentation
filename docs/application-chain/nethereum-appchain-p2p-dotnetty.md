---
title: "Nethereum.AppChain.P2P.DotNetty"
sidebar_label: "Nethereum.AppChain.P2P.DotNetty"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.P2P.DotNetty/README.md"
format: md
---

# Nethereum.AppChain.P2P.DotNetty

> **NuGet**: [`Nethereum.AppChain.P2P.DotNetty`](https://www.nuget.org/packages/Nethereum.AppChain.P2P.DotNetty/) | **Source**: [`src/Nethereum.AppChain.P2P.DotNetty/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.P2P.DotNetty)
# Nethereum.AppChain.P2P.DotNetty

> **PREVIEW** — This package is in preview. APIs may change between releases.

High-performance DotNetty-based P2P transport for [Nethereum AppChain](nethereum-appchain) networking with TLS support, peer discovery, and binary message framing.
...
### Used By (Consumers)
- **[Nethereum.AppChain.P2P.Server](nethereum-appchain-p2p-server)** - P2P server uses DotNetty transport
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - Main server uses DotNetty for Clique consensus

### Dependencies
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - `IP2PTransport` interface and message types
