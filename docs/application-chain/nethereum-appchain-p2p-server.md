---
title: "Nethereum.AppChain.P2P.Server"
sidebar_label: "Nethereum.AppChain.P2P.Server"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.P2P.Server/README.md"
format: md
---

# Nethereum.AppChain.P2P.Server

> **NuGet**: [`Nethereum.AppChain.P2P.Server`](https://www.nuget.org/packages/Nethereum.AppChain.P2P.Server/) | **Source**: [`src/Nethereum.AppChain.P2P.Server/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.P2P.Server)
# Nethereum.AppChain.P2P.Server

> **PREVIEW** — This package is in preview. APIs may change between releases.

[Nethereum AppChain](nethereum-appchain) node with integrated DotNetty P2P networking and Clique PoA consensus.
...
### Dependencies
- **[Nethereum.Consensus.Clique](nethereum-consensus-clique)** - Clique PoA consensus
- **[Nethereum.AppChain.P2P.DotNetty](nethereum-appchain-p2p-dotnetty)** - P2P transport
- **[Nethereum.AppChain](nethereum-appchain)** - Core chain abstraction

### See Also
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - Full-featured AppChain server with HTTP sync, anchoring, MUD deployment, and batch serving
