---
title: "Nethereum.AppChain.P2P"
sidebar_label: "Nethereum.AppChain.P2P"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.P2P/README.md"
format: md
---

# Nethereum.AppChain.P2P

> **NuGet**: [`Nethereum.AppChain.P2P`](https://www.nuget.org/packages/Nethereum.AppChain.P2P/) | **Source**: [`src/Nethereum.AppChain.P2P/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.P2P)
# Nethereum.AppChain.P2P

> **PREVIEW** — This package is in preview. APIs may change between releases.

Transport-agnostic peer-to-peer security components for [Nethereum AppChain](nethereum-appchain) networking — securing the layer that makes state synchronisable by anyone.
...
### Used By (Consumers)
- **[Nethereum.AppChain.P2P.DotNetty](nethereum-appchain-p2p-dotnetty)** - DotNetty transport wraps these security components

### Dependencies
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - Consensus and storage interfaces
- **[Nethereum.Signer](../signing-and-key-management/nethereum-signer)** - Cryptographic operations
