---
title: "Nethereum.AppChain.Policy"
sidebar_label: "Nethereum.AppChain.Policy"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.Policy/README.md"
format: md
---

# Nethereum.AppChain.Policy

> **NuGet**: [`Nethereum.AppChain.Policy`](https://www.nuget.org/packages/Nethereum.AppChain.Policy/) | **Source**: [`src/Nethereum.AppChain.Policy/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.Policy)
# Nethereum.AppChain.Policy

> **PREVIEW** — This package is in preview. APIs may change between releases.

Access control and governance for [Nethereum AppChain](nethereum-appchain) — your business, your rules.
...
### Used By (Consumers)
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - Integrates policy enforcement in the server pipeline

### Dependencies
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - Chain state access
- **[Nethereum.Web3](../core-foundation/nethereum-web3)** - L1 contract queries
