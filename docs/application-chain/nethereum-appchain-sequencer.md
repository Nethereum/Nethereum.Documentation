---
title: "Nethereum.AppChain.Sequencer"
sidebar_label: "Nethereum.AppChain.Sequencer"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.Sequencer/README.md"
format: md
---

# Nethereum.AppChain.Sequencer

> **NuGet**: [`Nethereum.AppChain.Sequencer`](https://www.nuget.org/packages/Nethereum.AppChain.Sequencer/) | **Source**: [`src/Nethereum.AppChain.Sequencer/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.Sequencer)
# Nethereum.AppChain.Sequencer

> **PREVIEW** — This package is in preview. APIs may change between releases.

Transaction ordering, block production, policy enforcement, and batch creation for [Nethereum AppChain](nethereum-appchain) networks.
...
### Used By (Consumers)
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - HTTP server hosting the sequencer
- **[Nethereum.AppChain.Metrics](nethereum-appchain-metrics)** - Instruments sequencer operations

### Dependencies
- **[Nethereum.AppChain](nethereum-appchain)** - Core chain abstraction
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - Block production and transaction processing
