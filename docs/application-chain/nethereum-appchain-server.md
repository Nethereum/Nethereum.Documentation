---
title: "Nethereum.AppChain.Server"
sidebar_label: "Nethereum.AppChain.Server"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.Server/README.md"
format: md
---

# Nethereum.AppChain.Server

> **NuGet**: [`Nethereum.AppChain.Server`](https://www.nuget.org/packages/Nethereum.AppChain.Server/) | **Source**: [`src/Nethereum.AppChain.Server/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.Server)
# Nethereum.AppChain.Server

> **PREVIEW** — This package is in preview. APIs may change between releases.

Production-ready server for running a [Nethereum AppChain](nethereum-appchain) — a lightweight, domain-specific execution layer that extends Ethereum L1/L2 with publicly readable, cryptographically verifiable state.
...
### See Also
- **[Nethereum.AppChain.P2P.Server](nethereum-appchain-p2p-server)** - Simpler P2P-focused server
- **[Nethereum.DevChain.Server](../devchain/nethereum-devchain-server)** - Development chain server
