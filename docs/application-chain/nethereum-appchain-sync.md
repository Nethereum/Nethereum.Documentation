---
title: "Nethereum.AppChain.Sync"
sidebar_label: "Nethereum.AppChain.Sync"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain.Sync/README.md"
format: md
---

# Nethereum.AppChain.Sync

> **NuGet**: [`Nethereum.AppChain.Sync`](https://www.nuget.org/packages/Nethereum.AppChain.Sync/) | **Source**: [`src/Nethereum.AppChain.Sync/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain.Sync)
# Nethereum.AppChain.Sync

> **PREVIEW** — This package is in preview. APIs may change between releases.

Synchronisation services for [Nethereum AppChain](nethereum-appchain) follower nodes — enabling anyone to independently sync, verify, and read AppChain state.
...
### Used By (Consumers)
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - HTTP server with sync endpoints
- **[Nethereum.AppChain.Sequencer](nethereum-appchain-sequencer)** - Sequencer coordinator uses sync for initial catch-up

### Dependencies
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - Transaction processor and state root calculation
