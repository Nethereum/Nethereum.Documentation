---
title: "Nethereum.AppChain"
sidebar_label: "Nethereum.AppChain"
sidebar_position: 100
description: "> PREVIEW — This package is in preview. APIs may change between releases."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.AppChain/README.md"
format: md
---

# Nethereum.AppChain

> **NuGet**: [`Nethereum.AppChain`](https://www.nuget.org/packages/Nethereum.AppChain/) | **Source**: [`src/Nethereum.AppChain/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.AppChain)
# Nethereum.AppChain
...
### Used By (Consumers)
- **[Nethereum.AppChain.Sequencer](nethereum-appchain-sequencer)** - Block production and transaction ordering
- **[Nethereum.AppChain.Sync](nethereum-appchain-sync)** - Follower synchronization
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - HTTP JSON-RPC server

### Dependencies
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - Storage interfaces and state root calculation
- **[Nethereum.Model](../core-foundation/nethereum-model)** - Block and transaction data structures
