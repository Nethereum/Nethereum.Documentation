---
title: "Nethereum.Consensus.Clique"
sidebar_label: "Nethereum.Consensus.Clique"
sidebar_position: 100
description: "Pluggable Clique Proof-of-Authority (EIP-225) consensus engine for Nethereum CoreChain and AppChain."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Consensus.Clique/README.md"
format: md
---

# Nethereum.Consensus.Clique

> **NuGet**: [`Nethereum.Consensus.Clique`](https://www.nuget.org/packages/Nethereum.Consensus.Clique/) | **Source**: [`src/Nethereum.Consensus.Clique/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Consensus.Clique)
# Nethereum.Consensus.Clique
...
### Used By (Consumers)
- **[Nethereum.AppChain.Server](nethereum-appchain-server)** - Uses Clique for multi-validator AppChain consensus
- **[Nethereum.AppChain.P2P.Server](nethereum-appchain-p2p-server)** - Uses Clique with DotNetty P2P networking

### Dependencies
- **[Nethereum.CoreChain](../devchain/nethereum-corechain)** - Consensus interfaces and block production pipeline
- **[Nethereum.Signer](../signing-and-key-management/nethereum-signer)** - ECDSA cryptographic operations
- **[Nethereum.Model](../core-foundation/nethereum-model)** - Block header data structures and encoding
