---
title: "Nethereum.Blazor.Solidity"
sidebar_label: "Nethereum.Blazor.Solidity"
sidebar_position: 100
description: "Blazor components for EVM transaction debugging with Solidity source mapping, step-through execution, and Monaco editor integration."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Blazor.Solidity/README.md"
format: md
---

# Nethereum.Blazor.Solidity

> **NuGet**: [`Nethereum.Blazor.Solidity`](https://www.nuget.org/packages/Nethereum.Blazor.Solidity/) | **Source**: [`src/Nethereum.Blazor.Solidity/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Blazor.Solidity)
# Nethereum.Blazor.Solidity
...
- [Nethereum.EVM](../evm-simulator/nethereum-evm) - EVM simulator and instruction set
- [Nethereum.Blazor](nethereum-blazor) - Blazor wallet integration and authentication
- [Nethereum.Explorer](../data-and-indexing/nethereum-explorer) - Blazor Server block explorer that embeds the debugger
