---
title: "Nethereum.MudBlazorComponents"
sidebar_label: "Nethereum.MudBlazorComponents"
sidebar_position: 100
description: "Blazor components in MudBlazor for simple data input for smart contracts and MUD (mud.dev) tables. Used by Nethereum code generator to create complete Blazor pages per smart contract with deployment, "
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.MudBlazorComponents/README.md"
format: md
---

# Nethereum.MudBlazorComponents

> **NuGet**: [`Nethereum.MudBlazorComponents`](https://www.nuget.org/packages/Nethereum.MudBlazorComponents/) | **Source**: [`src/Nethereum.MudBlazorComponents/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.MudBlazorComponents)
# Nethereum.MudBlazorComponents
