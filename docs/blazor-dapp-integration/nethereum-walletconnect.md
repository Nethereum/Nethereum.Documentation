---
title: "Nethereum.WalletConnect"
sidebar_label: "Nethereum.WalletConnect"
sidebar_position: 100
description: "WalletConnect v2 protocol integration for connecting desktop and web applications to mobile wallet apps using QR code pairing."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.WalletConnect/README.md"
format: md
---

# Nethereum.WalletConnect

> **NuGet**: [`Nethereum.WalletConnect`](https://www.nuget.org/packages/Nethereum.WalletConnect/) | **Source**: [`src/Nethereum.WalletConnect/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.WalletConnect)
# Nethereum.WalletConnect
