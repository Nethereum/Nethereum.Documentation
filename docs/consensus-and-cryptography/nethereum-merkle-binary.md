---
title: "Nethereum.Merkle.Binary"
sidebar_label: "Nethereum.Merkle.Binary"
sidebar_position: 100
description: "Binary Merkle Trie implementation for Ethereum stateless execution per [EIP-7864](https://eips.ethereum.org/EIPS/eip-7864). Provides a stem-based binary trie with 256-value stem nodes, proof generatio"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Merkle.Binary/README.md"
format: md
---

# Nethereum.Merkle.Binary

> **NuGet**: [`Nethereum.Merkle.Binary`](https://www.nuget.org/packages/Nethereum.Merkle.Binary/) | **Source**: [`src/Nethereum.Merkle.Binary/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Merkle.Binary)
# Nethereum.Merkle.Binary
