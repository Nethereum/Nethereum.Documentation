...
description: ".NET client for the Ethereum Beacon Chain REST API, providing access to consensus-layer state, light client bootstrap, sync committee updates, and finality data."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Beaconchain/README.md"
format: md
---

# Nethereum.Beaconchain

> **NuGet**: [`Nethereum.Beaconchain`](https://www.nuget.org/packages/Nethereum.Beaconchain/) | **Source**: [`src/Nethereum.Beaconchain/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Beaconchain)
# Nethereum.Beaconchain
