---
title: "Nethereum.Accounts"
sidebar_label: "Nethereum.Accounts"
sidebar_position: 100
description: "Nethereum.Accounts provides account management and transaction signing capabilities for Ethereum. It enables offline transaction signing, key management, and integration with external signers (hardwar"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Accounts/README.md"
format: md
---

# Nethereum.Accounts

> **NuGet**: [`Nethereum.Accounts`](https://www.nuget.org/packages/Nethereum.Accounts/) | **Source**: [`src/Nethereum.Accounts/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Accounts)
# Nethereum.Accounts
...
### See Also
- [Nethereum.Web3](nethereum-web3) - High-level Web3 API
- [Nethereum.HdWallet](../signing-and-key-management/nethereum-hdwallet) - HD Wallet implementation
- [Nethereum.Signer](../signing-and-key-management/nethereum-signer) - Transaction and message signing
