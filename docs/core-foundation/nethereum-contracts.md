---
title: "Nethereum.Contracts"
sidebar_label: "Nethereum.Contracts"
sidebar_position: 100
description: "Nethereum.Contracts is the core library for interacting with Ethereum smart contracts via RPC. It provides strongly-typed contract interaction, automatic ABI encoding/decoding, event filtering, and co"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Contracts/README.md"
format: md
---

# Nethereum.Contracts

> **NuGet**: [`Nethereum.Contracts`](https://www.nuget.org/packages/Nethereum.Contracts/) | **Source**: [`src/Nethereum.Contracts/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Contracts)
# Nethereum.Contracts
