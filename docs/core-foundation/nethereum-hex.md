---
title: "Nethereum.Hex"
sidebar_label: "Nethereum.Hex"
sidebar_position: 100
description: "Hexadecimal encoding and decoding utilities for Ethereum-specific types including String, BigInteger, and byte arrays."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Hex/README.md"
format: md
---

# Nethereum.Hex

> **NuGet**: [`Nethereum.Hex`](https://www.nuget.org/packages/Nethereum.Hex/) | **Source**: [`src/Nethereum.Hex/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Hex)
# Nethereum.Hex
