---
title: "Nethereum.Model"
sidebar_label: "Nethereum.Model"
sidebar_position: 100
description: "Core Ethereum data models representing transactions, blocks, accounts, and cryptographic signatures."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Model/README.md"
format: md
---

# Nethereum.Model

> **NuGet**: [`Nethereum.Model`](https://www.nuget.org/packages/Nethereum.Model/) | **Source**: [`src/Nethereum.Model/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Model)
# Nethereum.Model
