---
title: "Nethereum.RPC.Extensions"
sidebar_label: "Nethereum.RPC.Extensions"
sidebar_position: 100
description: "Nethereum.RPC.Extensions provides RPC extensions for Ethereum development tools and test environments. It includes support for Hardhat, Anvil (Foundry), and generic EVM manipulation methods that allow"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.RPC.Extensions/README.md"
format: md
---

# Nethereum.RPC.Extensions

> **NuGet**: [`Nethereum.RPC.Extensions`](https://www.nuget.org/packages/Nethereum.RPC.Extensions/) | **Source**: [`src/Nethereum.RPC.Extensions/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.RPC.Extensions)
# Nethereum.RPC.Extensions
