---
title: "Nethereum.RPC.Reactive"
sidebar_label: "Nethereum.RPC.Reactive"
sidebar_position: 100
description: "Nethereum.RPC.Reactive provides Reactive Extensions (Rx.NET) support for Ethereum RPC operations. It enables reactive programming patterns for monitoring blockchain events, streaming blocks and transa"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.RPC.Reactive/README.md"
format: md
---

# Nethereum.RPC.Reactive

> **NuGet**: [`Nethereum.RPC.Reactive`](https://www.nuget.org/packages/Nethereum.RPC.Reactive/) | **Source**: [`src/Nethereum.RPC.Reactive/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.RPC.Reactive)
# Nethereum.RPC.Reactive
