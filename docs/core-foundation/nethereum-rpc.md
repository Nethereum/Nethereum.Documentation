---
title: "Nethereum.RPC"
sidebar_label: "Nethereum.RPC"
sidebar_position: 100
description: "Nethereum.RPC is the core package providing Ethereum JSON-RPC method implementations. It contains all standard Ethereum RPC methods organized into logical categories (Eth, Net, Web3, Personal, etc.) a"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.RPC/README.md"
format: md
---

# Nethereum.RPC

> **NuGet**: [`Nethereum.RPC`](https://www.nuget.org/packages/Nethereum.RPC/) | **Source**: [`src/Nethereum.RPC/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.RPC)
# Nethereum.RPC
