...
sidebar_label: "Nethereum.Web3"
sidebar_position: 100
description: "Nethereum.Web3 is the main facade and entry point for interacting with Ethereum. It provides a high-level API that combines RPC methods, contract interaction, account management, and utility functions"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Web3/README.md"
format: md
---

# Nethereum.Web3

> **NuGet**: [`Nethereum.Web3`](https://www.nuget.org/packages/Nethereum.Web3/) | **Source**: [`src/Nethereum.Web3/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Web3)
# Nethereum.Web3
...
- [Account Management Guide](nethereum-accounts)
- [Contract Interaction Guide](nethereum-contracts)
