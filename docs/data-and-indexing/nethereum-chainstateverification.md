---
title: "Nethereum.ChainStateVerification"
sidebar_label: "Nethereum.ChainStateVerification"
sidebar_position: 100
description: "Nethereum.ChainStateVerification provides verified execution-state primitives using cryptographic proofs rooted in consensus-layer light client state. It enables trustless querying of account balances"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.ChainStateVerification/README.md"
format: md
---

# Nethereum.ChainStateVerification

> **NuGet**: [`Nethereum.ChainStateVerification`](https://www.nuget.org/packages/Nethereum.ChainStateVerification/) | **Source**: [`src/Nethereum.ChainStateVerification/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.ChainStateVerification)
# Nethereum.ChainStateVerification
