---
title: "Nethereum.Explorer"
sidebar_label: "Nethereum.Explorer"
sidebar_position: 100
description: "Blazor Server blockchain explorer Razor Class Library for Ethereum-compatible chains with indexed storage, ABI decoding, EVM debugging, and wallet interaction."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Explorer/README.md"
format: md
---

# Nethereum.Explorer

> **NuGet**: [`Nethereum.Explorer`](https://www.nuget.org/packages/Nethereum.Explorer/) | **Source**: [`src/Nethereum.Explorer/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Explorer)
# Nethereum.Explorer
...
- [Nethereum.Blazor](../web-and-browser-integration/nethereum-blazor) - EIP-6963 wallet interop and Ethereum authentication provider
- [Nethereum.Blazor.Solidity](../web-and-browser-integration/nethereum-blazor-solidity) - EVM debugger components and Solidity code viewer
- **Nethereum.DataServices** - ABI info storage implementations (Sourcify, Etherscan, 4Byte)
