...
description: "Client library for accessing external blockchain data APIs — Etherscan, Sourcify V2, CoinGecko, 4Byte Directory, and Chainlist. Includes a composite ABI retrieval system with automatic fallback across"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.DataServices/README.md"
format: md
---

# Nethereum.DataServices

> **NuGet**: [`Nethereum.DataServices`](https://www.nuget.org/packages/Nethereum.DataServices/) | **Source**: [`src/Nethereum.DataServices/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.DataServices)
# Nethereum.DataServices
...
`ISourcifyRepository` provides a database abstraction for storing Sourcify contract data locally. See [Nethereum.Sourcify.Database](nethereum-sourcify-database) for the PostgreSQL EF Core implementation.
