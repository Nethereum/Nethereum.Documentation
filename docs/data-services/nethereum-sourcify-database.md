---
title: "Nethereum.Sourcify.Database"
sidebar_label: "Nethereum.Sourcify.Database"
sidebar_position: 100
description: "EF Core (PostgreSQL) implementation of `ISourcifyRepository` for storing Sourcify verified contract data locally. Provides a complete relational schema mirroring Sourcify's data model with 10 entity t"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Sourcify.Database/README.md"
format: md
---

# Nethereum.Sourcify.Database

> **NuGet**: [`Nethereum.Sourcify.Database`](https://www.nuget.org/packages/Nethereum.Sourcify.Database/) | **Source**: [`src/Nethereum.Sourcify.Database/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Sourcify.Database)
# Nethereum.Sourcify.Database
