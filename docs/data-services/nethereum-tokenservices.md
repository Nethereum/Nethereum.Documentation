---
title: "Nethereum.TokenServices"
sidebar_label: "Nethereum.TokenServices"
sidebar_position: 100
description: "A standalone .NET library for ERC20 token discovery, balance retrieval, pricing, and multi-account scanning. Designed for multi-chain support with pluggable providers and discovery strategies."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.TokenServices/README.md"
format: md
---

# Nethereum.TokenServices

> **NuGet**: [`Nethereum.TokenServices`](https://www.nuget.org/packages/Nethereum.TokenServices/) | **Source**: [`src/Nethereum.TokenServices/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.TokenServices)
# Nethereum.TokenServices
