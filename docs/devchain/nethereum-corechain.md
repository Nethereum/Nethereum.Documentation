---
title: "Nethereum.CoreChain"
sidebar_label: "Nethereum.CoreChain"
sidebar_position: 100
description: "Core blockchain infrastructure for state management, block production, transaction processing, and JSON-RPC handling. Provides the foundational components for building local Ethereum nodes and develop"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.CoreChain/README.md"
format: md
---

# Nethereum.CoreChain

> **NuGet**: [`Nethereum.CoreChain`](https://www.nuget.org/packages/Nethereum.CoreChain/) | **Source**: [`src/Nethereum.CoreChain/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.CoreChain)
# Nethereum.CoreChain
