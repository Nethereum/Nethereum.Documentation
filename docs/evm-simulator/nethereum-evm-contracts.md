---
title: "Nethereum.EVM.Contracts"
sidebar_label: "Nethereum.EVM.Contracts"
sidebar_position: 100
description: "Nethereum.EVM.Contracts provides high-level contract simulators built on top of Nethereum.EVM for testing and analyzing smart contract behavior without broadcasting transactions."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.EVM.Contracts/README.md"
format: md
---

# Nethereum.EVM.Contracts

> **NuGet**: [`Nethereum.EVM.Contracts`](https://www.nuget.org/packages/Nethereum.EVM.Contracts/) | **Source**: [`src/Nethereum.EVM.Contracts/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.EVM.Contracts)
# Nethereum.EVM.Contracts
