---
title: "Nethereum.EVM"
sidebar_label: "Nethereum.EVM"
sidebar_position: 100
description: "Nethereum.EVM is a production-ready Ethereum Virtual Machine (EVM) execution engine that runs bytecode instruction-by-instruction with full trace support and gas calculation. Passes all Ethereum VM an"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.EVM/README.md"
format: md
---

# Nethereum.EVM

> **NuGet**: [`Nethereum.EVM`](https://www.nuget.org/packages/Nethereum.EVM/) | **Source**: [`src/Nethereum.EVM/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.EVM)
# Nethereum.EVM
