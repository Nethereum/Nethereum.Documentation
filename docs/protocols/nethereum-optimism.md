---
title: "Nethereum.Optimism"
sidebar_label: "Nethereum.Optimism"
sidebar_position: 100
description: "Contract services for Optimism L2 bridges and cross-domain messaging. Provides typed interfaces for depositing/withdrawing ETH and ERC20 tokens between Ethereum (L1) and Optimism (L2)."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Optimism/README.md"
format: md
---

# Nethereum.Optimism

> **NuGet**: [`Nethereum.Optimism`](https://www.nuget.org/packages/Nethereum.Optimism/) | **Source**: [`src/Nethereum.Optimism/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Optimism)
# Nethereum.Optimism
