...
description: "Embedded circuit artifacts for the [0xbow Privacy Pools](https://github.com/0xbow-io/privacy-pools-core) protocol. Provides `PrivacyPoolCircuitSource` — implements both `ICircuitArtifactSource` and `I"
