---
title: "Nethereum.Signer.Bls"
sidebar_label: "Nethereum.Signer.Bls"
sidebar_position: 100
description: "Core BLS signature abstraction for Ethereum consensus layer operations (Beacon Chain, sync committees, light clients)."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Signer.Bls/README.md"
format: md
---

# Nethereum.Signer.Bls

> **NuGet**: [`Nethereum.Signer.Bls`](https://www.nuget.org/packages/Nethereum.Signer.Bls/) | **Source**: [`src/Nethereum.Signer.Bls/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Signer.Bls)
# Nethereum.Signer.Bls
