---
title: "Nethereum.Signer"
sidebar_label: "Nethereum.Signer"
sidebar_position: 100
description: "Cryptographic signing library for Ethereum transactions, messages, and typed data using secp256k1 elliptic curve cryptography."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Signer/README.md"
format: md
---

# Nethereum.Signer

> **NuGet**: [`Nethereum.Signer`](https://www.nuget.org/packages/Nethereum.Signer/) | **Source**: [`src/Nethereum.Signer/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Signer)
# Nethereum.Signer
