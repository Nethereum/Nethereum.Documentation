---
title: "Nethereum.Wallet.UI.Components.Blazor.Trezor"
sidebar_label: "Nethereum.Wallet.UI.Components.Blazor.Trezor"
sidebar_position: 100
description: "Blazor Razor components and prompt dialogs for Trezor hardware wallet integration. Provides browser-based UI for PIN entry, passphrase prompts, and account management for Trezor devices."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Wallet.UI.Components.Blazor.Trezor/README.md"
format: md
---

# Nethereum.Wallet.UI.Components.Blazor.Trezor

> **NuGet**: [`Nethereum.Wallet.UI.Components.Blazor.Trezor`](https://www.nuget.org/packages/Nethereum.Wallet.UI.Components.Blazor.Trezor/) | **Source**: [`src/Nethereum.Wallet.UI.Components.Blazor.Trezor/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Wallet.UI.Components.Blazor.Trezor)
# Nethereum.Wallet.UI.Components.Blazor.Trezor
