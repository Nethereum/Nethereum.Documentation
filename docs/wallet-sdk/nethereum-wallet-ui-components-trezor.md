---
title: "Nethereum.Wallet.UI.Components.Trezor"
sidebar_label: "Nethereum.Wallet.UI.Components.Trezor"
sidebar_position: 100
description: "Platform-agnostic ViewModels and business logic for integrating Trezor hardware wallets into Nethereum wallet UIs. Provides MVVM-based components that can be consumed by any UI framework (Blazor, Aval"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Wallet.UI.Components.Trezor/README.md"
format: md
---

# Nethereum.Wallet.UI.Components.Trezor

> **NuGet**: [`Nethereum.Wallet.UI.Components.Trezor`](https://www.nuget.org/packages/Nethereum.Wallet.UI.Components.Trezor/) | **Source**: [`src/Nethereum.Wallet.UI.Components.Trezor/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Wallet.UI.Components.Trezor)
# Nethereum.Wallet.UI.Components.Trezor
