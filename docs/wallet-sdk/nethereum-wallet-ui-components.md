---
title: "Nethereum.Wallet.UI.Components"
sidebar_label: "Nethereum.Wallet.UI.Components"
sidebar_position: 100
description: "Platform-agnostic wallet UI components, view models, and services for Nethereum applications. Provides MVVM-based ViewModels and business logic that can be consumed by any UI framework (Blazor, Avalon"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Wallet.UI.Components/README.md"
format: md
---

# Nethereum.Wallet.UI.Components

> **NuGet**: [`Nethereum.Wallet.UI.Components`](https://www.nuget.org/packages/Nethereum.Wallet.UI.Components/) | **Source**: [`src/Nethereum.Wallet.UI.Components/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Wallet.UI.Components)
# Nethereum.Wallet.UI.Components
