---
title: "Nethereum.Blazor"
sidebar_label: "Nethereum.Blazor"
sidebar_position: 100
description: "Blazor integration for Ethereum wallets with EIP-6963 multi-wallet discovery, authentication, and local storage utilities."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.Blazor/README.md"
format: md
---

# Nethereum.Blazor

> **NuGet**: [`Nethereum.Blazor`](https://www.nuget.org/packages/Nethereum.Blazor/) | **Source**: [`src/Nethereum.Blazor/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.Blazor)
# Nethereum.Blazor
