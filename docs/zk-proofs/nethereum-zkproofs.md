---
title: "Nethereum.ZkProofs"
sidebar_label: "Nethereum.ZkProofs"
sidebar_position: 100
description: "Provider-agnostic interfaces and models for zero-knowledge proof generation and verification in .NET. This package defines the core abstractions that all Nethereum ZK proof providers implement."
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.ZkProofs/README.md"
format: md
---

# Nethereum.ZkProofs

> **NuGet**: [`Nethereum.ZkProofs`](https://www.nuget.org/packages/Nethereum.ZkProofs/) | **Source**: [`src/Nethereum.ZkProofs/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.ZkProofs)
