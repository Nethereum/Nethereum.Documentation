---
title: "Nethereum.ZkProofsVerifier"
sidebar_label: "Nethereum.ZkProofsVerifier"
sidebar_position: 100
description: "Native .NET Groth16 proof verification for Circom/snarkjs circuits on the BN128 curve. Verify zero-knowledge proofs entirely in C# without external dependencies on native libraries or JavaScript runti"
custom_edit_url: "https://github.com/Nethereum/Nethereum/edit/master/src/Nethereum.ZkProofsVerifier/README.md"
format: md
---

# Nethereum.ZkProofsVerifier

> **NuGet**: [`Nethereum.ZkProofsVerifier`](https://www.nuget.org/packages/Nethereum.ZkProofsVerifier/) | **Source**: [`src/Nethereum.ZkProofsVerifier/`](https://github.com/Nethereum/Nethereum/tree/master/src/Nethereum.ZkProofsVerifier)
# Nethereum.ZkProofsVerifier
